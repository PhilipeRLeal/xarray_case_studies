...
def binned_statistic_1d(da, dim, bins=10, statistic='count', value_range=None):
    ...
    if isinstance(bins, int):
        ...
        bins = np.linspace(value_range[0], value_range[1], bins+1).round(2)
...
if '__main__' == __name__:
    ...
    binned = binned_statistic_1d(ds['Tair'].fillna(0), 'time', 15)
    
    binned.plot.pcolormesh(col='groups', col_wrap=4)